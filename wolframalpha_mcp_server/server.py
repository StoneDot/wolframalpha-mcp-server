...
UNIT_CATEGORIES = {
    ...
    "temperature": [
        ...
        "degree_celsius", "degrees_celsius", "degree_fahrenheit", "degrees_fahrenheit",
        # Abbreviations
        "K", "R", "°C", "°F", "°K", "°R"
    ],
    "time": [
    ...
    "speed": [
        ...
        # Abbreviations
        "m/s", "km/h", "mph", "kn", "kt", "ft/s", "fps", "fpm", "c"
    ],
    "angle": [
        # Full names (singular and plural)
        ...
        # Abbreviations
        "°", "deg", "rad", "grad", "mrad", "arcsec", "arcmin", "rev"
    ],
    "electrical_current": [
        # Full names (singular and plural)
        "ampere", "amperes", "milliampere", "milliamperes", "microampere", "microamperes",
        "kiloampere", "kiloamperes", "nanoampere", "nanoamperes",
        # Abbreviations
        "A", "mA", "μA", "kA", "nA"
    ],
    "voltage": [
        # Full names (singular and plural)
        "volt", "volts", "millivolt", "millivolts", "microvolt", "microvolts",
        "kilovolt", "kilovolts", "megavolt", "megavolts",
        # Abbreviations
        "V", "mV", "μV", "kV", "MV"
    ],
    "electrical_resistance": [
        # Full names (singular and plural)
        "ohm", "ohms", "milliohm", "milliohms", "kiloohm", "kiloohms",
        "megaohm", "megaohms", "gigaohm", "gigaohms",
        # Abbreviations
        "Ω", "mΩ", "kΩ", "MΩ", "GΩ"
    ],
    "electrical_capacitance": [
        # Full names (singular and plural)
        "farad", "farads", "microfarad", "microfarads", "nanofarad", "nanofarads",
        "picofarad", "picofarads", "millifarad", "millifarads",
        # Abbreviations
        "F", "μF", "nF", "pF", "mF"
    ],
    "electrical_charge": [
        # Full names (singular and plural)
        "coulomb", "coulombs", "millicoulomb", "millicoulombs", "microcoulomb", "microcoulombs",
        "nanocoulomb", "nanocoulombs", "electron_charge",
        # Abbreviations
        "C", "mC", "μC", "nC", "e"
    ],
    "electrical_conductance": [
        # Full names (singular and plural)
        "siemens", "millisiemens", "microsiemens", "kilosiemens",
        # Abbreviations
        "S", "mS", "μS", "kS"
    ],
    "acceleration": [
    ...
    "force": [
        # Full names (singular and plural)
        "newton", "newtons", "kilonewton", "kilonewtons", "meganewton", "meganewtons",
        "dyne", "dynes", "pound_force", "pounds_force", "kilogram_force", "kilograms_force",
        "ton_force", "tons_force", "ounce_force", "ounces_force",
        # Abbreviations
        "N", "kN", "MN", "dyn", "lbf", "kgf", "tonf", "ozf"
    ],
    "momentum": [
        # Full names (singular and plural)
        "kilogram_meter_per_second", "kilogram_meters_per_second", "newton_second", "newton_seconds",
        "pound_foot_per_second", "pound_feet_per_second",
        # Abbreviations
        "kg⋅m/s", "N⋅s", "lb⋅ft/s"
    ],
    "angular_acceleration": [
        # Full names (singular and plural)
        "radian_per_second_squared", "radians_per_second_squared", "degree_per_second_squared", "degrees_per_second_squared",
        "revolution_per_second_squared", "revolutions_per_second_squared",
        # Abbreviations
        "rad/s²", "deg/s²", "rev/s²"
    ],
    "magnetic_flux": [
        # Full names (singular and plural)
        "weber", "webers", "milliweber", "milliwebers", "microweber", "microwebers",
        "maxwell", "maxwells",
        # Abbreviations
        "Wb", "mWb", "μWb", "Mx"
    ],
    "magnetic_flux_density": [
        # Full names (singular and plural)
        "tesla", "teslas", "millitesla", "milliteslas", "microtesla", "microteslas",
        "nanotesla", "nanoteslas", "gauss", "kilogauss",
        # Abbreviations
        "T", "mT", "μT", "nT", "G", "kG"
    ],
    "inductance": [
        # Full names (singular and plural)
        "henry", "henries", "millihenry", "millihenries", "microhenry", "microhenries",
        "nanohenry", "nanohenries", "picohenry", "picohenries",
        # Abbreviations
        "H", "mH", "μH", "nH", "pH"
    ],
    "electric_field": [
        # Full names (singular and plural)
        "volt_per_meter", "volts_per_meter", "newton_per_coulomb", "newtons_per_coulomb",
        "kilovolt_per_meter", "kilovolts_per_meter",
        # Abbreviations
        "V/m", "N/C", "kV/m"
    ],
    "resistivity": [
        # Full names (singular and plural)
        "ohm_meter", "ohm_meters", "microohm_meter", "microohm_meters",
        "milliohm_meter", "milliohm_meters",
        # Abbreviations
        "Ω⋅m", "μΩ⋅m", "mΩ⋅m"
    ],
    "currency": [
    ...
    "specific_heat": [
        # Full names (singular and plural)
        "joule_per_kilogram_kelvin", "joules_per_kilogram_kelvin",
        "calorie_per_gram_celsius", "calories_per_gram_celsius",
        "btu_per_pound_fahrenheit", "btus_per_pound_fahrenheit",
        # Abbreviations
        "J/(kg⋅K)", "cal/(g⋅°C)", "BTU/(lb⋅°F)"
    ],
    "thermal_conductivity": [
        # Full names (singular and plural)
        "watt_per_meter_kelvin", "watts_per_meter_kelvin",
        "calorie_per_second_centimeter_celsius", "calories_per_second_centimeter_celsius",
        # Abbreviations
        "W/(m⋅K)", "cal/(s⋅cm⋅°C)"
    ],
    "frequency": [
        ...
        "cycle_per_second", "cycles_per_second",
        # Abbreviations
        "Hz", "kHz", "MHz", "GHz", "THz", "cps"
    ],
    "angular_velocity": [
        # Full names (singular and plural)
        "radian_per_second", "radians_per_second", "degree_per_second", "degrees_per_second",
        "revolution_per_minute", "revolutions_per_minute", "revolution_per_second", "revolutions_per_second",
        # Abbreviations
        "rad/s", "deg/s", "rpm", "rps"
    ],
    "density": [
        # Full names (singular and plural)
        "kilogram_per_cubic_meter", "kilograms_per_cubic_meter", "gram_per_cubic_centimeter", "grams_per_cubic_centimeter",
        "pound_per_cubic_foot", "pounds_per_cubic_foot", "gram_per_milliliter", "grams_per_milliliter",
        "kilogram_per_liter", "kilograms_per_liter", "ounce_per_cubic_inch", "ounces_per_cubic_inch",
        # Abbreviations
        "kg/m³", "g/cm³", "lb/ft³", "g/mL", "kg/L", "oz/in³"
    ],
    "viscosity": [
        # Full names (singular and plural)
        "pascal_second", "pascal_seconds", "poise", "centipoise", "stoke", "stokes", "centistoke", "centistokes",
        # Abbreviations
        "Pa⋅s", "P", "cP", "St", "cSt"
    ],
    "torque": [
        # Full names (singular and plural)
        "newton_meter", "newton_meters", "foot_pound_torque", "foot_pounds_torque", "inch_pound", "inch_pounds",
        "kilogram_force_meter", "kilogram_force_meters", "dyne_centimeter", "dyne_centimeters",
        # Abbreviations
        "N⋅m", "in⋅lb", "kgf⋅m", "dyn⋅cm"
    ],
    "flow_rate": [
        # Full names (singular and plural)
        "cubic_meter_per_second", "cubic_meters_per_second", "liter_per_minute", "liters_per_minute",
        "gallon_per_minute", "gallons_per_minute", "cubic_foot_per_minute", "cubic_feet_per_minute",
        "barrel_per_day", "barrels_per_day", "liter_per_second", "liters_per_second",
        # Abbreviations
        "m³/s", "L/min", "gpm", "cfm", "bbl/day", "L/s"
    ],
    "concentration": [
        # Full names (singular and plural)
        "mole_per_liter", "moles_per_liter", "gram_per_liter", "grams_per_liter",
        "milligram_per_liter", "milligrams_per_liter", "part_per_million", "parts_per_million",
        "part_per_billion", "parts_per_billion", "percent", "percent_by_weight", "percent_by_volume",
        # Abbreviations
        "mol/L", "M", "g/L", "mg/L", "ppm", "ppb", "%", "wt%", "vol%"
    ],
    "luminous_intensity": [
        # Full names (singular and plural)
        "candela", "candelas", "lumen", "lumens", "lux", "foot_candle", "foot_candles",
        "candela_per_square_meter", "candela_per_square_foot", "lambert", "lamberts",
        # Abbreviations
        "cd", "lm", "lx", "fc", "cd/m²", "cd/ft²"
    ],
    "radioactivity": [
        # Full names (singular and plural)
        ...
        # Abbreviations
        "Bq", "Ci", "mCi", "μCi", "Sv", "mSv", "Gy"
    ],
    "surface_tension": [
        # Full names (singular and plural)
        "newton_per_meter", "newtons_per_meter", "dyne_per_centimeter", "dynes_per_centimeter",
        "millinewton_per_meter", "millinewtons_per_meter",
        # Abbreviations
        "N/m", "dyn/cm", "mN/m"
    ],
    "moment_of_inertia": [
        # Full names (singular and plural)
        "kilogram_square_meter", "kilogram_square_meters", "gram_square_centimeter", "gram_square_centimeters",
        "pound_square_foot", "pound_square_feet", "ounce_square_inch", "ounce_square_inches",
        # Abbreviations
